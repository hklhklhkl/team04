package com.ztkj.forum.post.servlet;
 ...
 */
@WebServlet("/back/forum/post/postServlet")
public class PostServlet extends HttpServlet {
	...
	protected void deletePost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	out.print("<script>location='/team04/back/forum/block/blockServlet?method=count'</script>");
	}
	...
	protected void updateUp(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(postUp==0){
			...
			if(flag){
	    		...
	    		out.print("<script>location='/team04/back/forum/post/postServlet?method=findAllPost'</script>");
		}
		if(postUp==1){
			flag = true;
